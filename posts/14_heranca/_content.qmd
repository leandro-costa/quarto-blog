...
::: {.callout-tip title="- É a capacidade de uma classe definir o seu comportamento e sua estrutura aproveitando definições de outra classe, normalmente conhecida como classe base ou classe pai"}
...
::: {.callout-warning title="Precisamos mesmo de outra classe?"}
...
::: {.callout-tip title="Super e Sub classe"}
...
::: {.callout-tip title="Sempre usar protected?"}
...
:::: {.callout-tip title="A anotação Override"}
